    ...
    <div class="sw_case">
        <a href="javascript:void(0)" @click.stop.prevent="jumpToPreview">
            ...
            <div class="image">
                ...
                <div class="mask"></div>
                <!--弹出提示框-->
                <a type="text" @click.stop.prevent="open2"><img title="删除案例" class="delete" src="http://publicst.jcy.cc/pc_master/img/delete.png" alt="删除"></a>
                <a class="editor" @click.stop.prevent="jumpToEdit"><img title="编辑案例" src="http://publicst.jcy.cc/pc_master/img/edit.png" alt="编辑"></a>
            </div>
            <div class="describe">
                <p class="first">
        ...
        computed: {
                ...
                auditText: function () {
                    if(this.caseDetail.audit == 1){
                        return "已发布";
                    }else if(this.caseDetail.audit == 3) {
                        return "审核未通过";
                    }
                    return "待审核";
                },
