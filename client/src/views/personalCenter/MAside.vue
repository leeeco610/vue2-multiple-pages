...
//                let bodyClient = document.body.clientHeight >= document.documentElement.clientHeight ? document.body.clientHeight: document.documentElement.clientHeight
                function winScroll () {
                    if(distance > 0){
                        if(document.body.clientHeight >aside_content &&  document.body.scrollTop >= distance){
                        ...
                        if(document.body.clientHeight >window.innerHeight && document.body.scrollTop > 200){
                            asideDemo.classList.add('fixed');
